	...
	return(
		<div className="grid__container">			
			<div className="grid__item">
				<span className="grid__item--header">{parseInt(props.purchasingHousePrice).toLocaleString('en-US', localeOptions)}</span>
				<input 
					type="range"
			...
			<div className="grid__item">
				<span className="grid__item--header">{parseInt(props.depositAmount).toLocaleString('en-US', localeOptions)}</span>
				<input 
					type="range"
					className="grid__item--range-slider"
					id="depositAmount" 
