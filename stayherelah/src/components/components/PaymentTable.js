  ...
  for (let i = 0; i < props.yearlyPayments.length; i++) {
    paymentMonthsArr.push(
      <tr key={props.yearlyPayments[i].year}>
        ...
        <td>
          {props.yearlyPayments[i].interestPaid.toLocaleString(
            "en-US",
            localeOptions
          )}
        </td>
        <td className="to-date-yearly-payment">
          {props.yearlyPayments[i].interestPaidToDate.toLocaleString(
            "en-US",
            localeOptions
          )}
        </td>
        <td>
          {props.yearlyPayments[i].principalRepaid.toLocaleString(
            "en-US",
            localeOptions
          )}
        </td>
        <td className="to-date-yearly-payment">
          {props.yearlyPayments[i].principalRepaidToDate.toLocaleString(
            "en-US",
            localeOptions
          )}
        </td>
        <td>
          {props.yearlyPayments[i].outstandingBalance.toLocaleString(
            "en-US",
            localeOptions
          )}
        </td>
